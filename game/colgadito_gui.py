...
class Game(spyral.Scene):
    ...
    def __init__(self, activity=None):
        ...
        self.background = spyral.Image(filename="images/Arbol.png").scale((self.width, self.height))
        self.erradas = ""

        self.hangman = Colgadito(self)
        self.tablero = Tablero(self)
        self.descartadas = Descartadas(self)
        self.infodato_label = None
        self.setup()
    ...
    def setup(self):
        ...
        if self.infodato_label:
            self.infodato_label.kill()
       
        
        self.infodato_label = MultilineText(self, self.infodato, self.width/5, 500, 650, 500)
